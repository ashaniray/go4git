...
## TODO
- New utility **gensha1** to generate hash of content (optional filename as arg, if no arg then read from stdin). Usage: ```gensha1 <filename> | hexdump -ve '1/1 "%.2x"'```. Compare with ```echo 'test content' | git hash-object --stdin```
